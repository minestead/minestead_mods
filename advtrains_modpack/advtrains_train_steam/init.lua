...
advtrains.register_wagon("newlocomotive", {
	...
	seats = {
		{
			...
			attach_offset={x=-5, y=4, z=-10},
			view_offset={x=-5, y=2, z=0},
			group = "dstand",
		},
		{
	...
	glow = 5, --supposed to disable effect of light to texture color, so that the entity always appears as full-bright
...
advtrains.register_wagon("detailed_steam_engine", {
	...
	seats = {
		{
			name=S("Driver Stand (left)"),
			attach_offset={x=-5, y=3, z=-10},
			view_offset={x = -5, y=0, z=0},
			group = "dstand",
		},
		{
			name=S("Driver Stand (right)"),
