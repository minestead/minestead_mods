...
local texture_order = {"darkgreen", "magenta", "blue", "cyan", "grey", "red", "pink", "darkgrey", "violet", "black", "green", "brown", "yellow", "orange", "white"}
...
for _, color in pairs(texture_order) do
