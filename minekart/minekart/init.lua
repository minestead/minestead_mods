...
if minetest.get_modpath("technic") then
    minetest.register_craftitem("minekart:wheel",{
        description = "Kart Wheel",
        inventory_image = "minekart_wheel.png",
    })

    minetest.register_craft({
        output = "minekart:wheel",
        recipe = {
                {"technic:rubber", "technic:rubber", "technic:rubber"},
                {"technic:rubber", "technic:stainless_steel_ingot", "technic:rubber"},
                {"technic:rubber", "technic:rubber", "technic:rubber"}
        }
    })

    minetest.register_craftitem("minekart:engine",{
        description = "Kart Engine",
        inventory_image = "minekart_engine.png",
    })

    minetest.register_craft({
        output = "minekart:engine",
        recipe = {
                {"basic_materials:gear_steel", "basic_materials:gear_steel", "basic_materials:gear_steel"},
                {"pipeworks:pipe_1_empty", "technic:stainless_steel_block", "pipeworks:pipe_1_empty"},
                {"basic_materials:gear_steel", "basic_materials:gear_steel", "basic_materials:gear_steel"}
        }
    })
	...
	minetest.register_craft({
		...
		recipe = {
			{"minekart:wheel", "technic:stainless_steel_ingot", "minekart:wheel"},
			{"technic:stainless_steel_ingot",    "minekart:engine",  "technic:stainless_steel_ingot"},
			{"minekart:wheel", "technic:stainless_steel_ingot", "minekart:wheel"},
		}
	})
