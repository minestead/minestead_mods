...
ropes.ropeLength = tonumber(minetest.settings:get("ropes_rope_length")) or 25
ropes.woodRopeBoxMaxMultiple = tonumber(minetest.settings:get("ropes_wood_rope_box_max_multiple")) or 1
ropes.copperRopeBoxMaxMultiple = tonumber(minetest.settings:get("ropes_copper_rope_box_max_multiple")) or 3
ropes.steelRopeBoxMaxMultiple = tonumber(minetest.settings:get("ropes_steel_rope_box_max_multiple")) or 5
ropes.create_all_definitions = minetest.settings:get_bool("ropes_create_all_definitions")

ropes.ropeLadderLength = tonumber(minetest.settings:get("ropes_rope_ladder_length")) or 25
...
if ropes.extending_ladder_enabled == nil then
	ropes.extending_ladder_enabled = false
end
